      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div class="bg-white rounded-2xl shadow-xl p-8 border border-accent/10">
            ...
            <form (ngSubmit)="submitForm()" #contactForm="ngForm" class="space-y-6">
              ...
              <div>
                ...
                <select 
                  ...
                  name="inquiryType" 
                  required
                  class="w-full px-4 py-3 border border-deep/20 rounded-xl focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-200"
                >
              ...
              <div>
                ...
                <textarea 
                  ...
                  required
                  rows="4"
                  class="w-full px-4 py-3 border border-deep/20 rounded-xl focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-200 resize-none"
              ...
              <button 
                ...
                class="w-full btn-primary py-4 px-6 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <!-- Success Message -->
            <div *ngIf="isSubmitted" class="mt-6 p-4 bg-accent/10 border border-accent/20 rounded-xl">
              <div class="flex items-center">
                <svg class="w-5 h-5 text-accent mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <p class="text-black font-medium">Thank you! We'll get back to you within 24 hours.</p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-8">
            ...
            <div class="space-y-6">
              <div class="flex items-start">
                <div class="bg-accent/10 text-accent p-3 rounded-xl mr-4">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-black">Email Us</h3>
                  <p class="text-muted">info&#64;wishcowork.com</p>
                  <p class="text-muted">support&#64;wishcowork.com</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  <h3 class="text-lg font-semibold text-black">Call Us</h3>
                  <p class="text-muted">+91 1800-123-WISH</p>
              ...
              <div class="flex items-start">
                ...
                <div>
                  <h3 class="text-lg font-semibold text-black">Visit Us</h3>
                  <p class="text-muted">Multiple locations across India</p>
                  <p class="text-muted">See all locations below</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-muted">Saturday - Sunday: 9:00 AM - 6:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex space-x-4">
                <a href="#" class="bg-accent/10 hover:bg-accent text-accent hover:text-black p-3 rounded-xl transition-all duration-300">
    ...
    <section class="py-16 brand-surface">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-black mb-4">Our Locations</h2>
          <p class="text-lg text-muted">Visit any of our premium coworking spaces across India</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6">
              ...
              <!-- Features -->
              <div class="mb-4">
                <h4 class="font-semibold text-black mb-2">Features:</h4>
                <div class="flex flex-wrap gap-2">
                  <span 
                    *ngFor="let feature of location.features.slice(0, 3)" 
                    class="bg-accent/10 text-accent px-2 py-1 rounded text-xs"
                  >
                    {{ feature }}
                  </span>
                  <span 
                    *ngIf="location.features.length > 3"
                    class="brand-surface text-muted px-2 py-1 rounded text-xs"
                  >
              ...
              <div class="flex gap-3">
                <button class="flex-1 btn-primary py-2 px-4 rounded-lg text-sm">
                  Schedule Tour
                </button>
                <button class="flex-1 btn-secondary py-2 px-4 rounded-lg text-sm">
                  Get Directions
                </button>
              </div>
            </div>
    ...
    <section class="py-16 bg-white">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-muted">Got questions? We've got answers.</p>
        </div>

        <div class="space-y-4">
          <div 
            *ngFor="let faq of faqs; let i = index" 
            class="border border-accent/10 rounded-xl overflow-hidden"
          >
            <button 
              (click)="toggleFaq(i)"
              class="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-sand transition-all duration-200"
            >
              <span class="font-semibold text-black">{{ faq.question }}</span>
              <svg 
            ...
            >
              <div class="px-6 pb-4 text-muted">
                {{ faq.answer }}
              </div>
            </div>
          </div>
...
export class ContactComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.updateMetaTags({
      title: `Contact Us - Get in Touch | ${appName}`,
      description: `Ready to join our community or have questions about our services? We're here to help you find the perfect workspace solution.`,
      keywords: 'contact wishcowork, workspace inquiry, office space support, coworking help'
    });
  }
