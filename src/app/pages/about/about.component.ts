...
@Component({
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 class="text-4xl md:text-5xl font-bold text-black mb-6">
              Revolutionizing the Way <span class="text-accent">India Works</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button class="btn-primary py-3 px-8">
                Join Our Community
              </button>
              <button class="btn-secondary py-3 px-8">
                Schedule a Tour
              </button>
            </div>
          </div>
          <div class="relative">
            ...
            <div class="absolute -bottom-6 -left-6 bg-white rounded-xl p-4 shadow-lg">
              <div class="text-center">
                ...
                <div class="text-sm text-muted">Happy Members</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            <h2 class="text-3xl font-bold text-black mb-6">Our Vision</h2>
            <p class="text-lg text-muted mb-6 leading-relaxed">
    ...
    <section class="py-16 brand-surface">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-black mb-4">WishCowork by the Numbers</h2>
          <p class="text-lg text-muted">Our journey so far in transforming India's workspace landscape</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div *ngFor="let stat of statistics" class="text-center">
            <div class="text-4xl font-bold text-accent mb-2">{{ stat.number }}</div>
            <div class="text-lg font-semibold text-black mb-1">{{ stat.label }}</div>
            <div class="text-sm text-muted">{{ stat.description }}</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 bg-white">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-black mb-4">Our Story</h2>
          <p class="text-lg text-muted">How WishCowork began and where we're heading</p>
        </div>
        
        <div class="space-y-12">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 class="text-2xl font-bold text-black mb-4">2020 - The Beginning</h3>
            ...
            <div class="bg-accent/10 rounded-2xl p-8">
              <div class="text-center">
                <div class="text-3xl font-bold text-accent mb-2">1</div>
                <div class="text-black font-semibold">Location</div>
                <div class="text-sm text-muted mt-2">Jaipur, Rajasthan</div>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div class="md:order-2">
              <h3 class="text-2xl font-bold text-black mb-4">2022 - Rapid Expansion</h3>
              <p class="text-muted mb-4">
            ...
            <div class="md:order-1 bg-accent/10 rounded-2xl p-8">
              <div class="text-center">
                <div class="text-3xl font-bold text-accent mb-2">15</div>
                <div class="text-black font-semibold">Locations</div>
                <div class="text-sm text-muted mt-2">8 Cities</div>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 class="text-2xl font-bold text-black mb-4">2025 - Present Day</h3>
              <p class="text-muted mb-4">
            ...
            <div class="bg-accent/10 rounded-2xl p-8">
              <div class="text-center">
                ...
                <div class="text-black font-semibold">Locations</div>
                <div class="text-sm text-muted mt-2">15+ Cities</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-16 bg-sand">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-black mb-4">Our Core Values</h2>
          <p class="text-lg text-muted">The principles that guide everything we do</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Community First</h3>
            <p class="text-muted">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Innovation</h3>
            <p class="text-muted">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Excellence</h3>
            <p class="text-muted">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Flexibility</h3>
            <p class="text-muted">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Sustainability</h3>
            <p class="text-muted">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <h3 class="text-xl font-bold text-black mb-4">Transparency</h3>
            <p class="text-muted">
    ...
    <section class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-black mb-4">Meet Our Leadership Team</h2>
          <p class="text-lg text-muted">The visionaries behind WishCowork's success</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div *ngFor="let member of teamMembers" class="bg-white rounded-2xl p-8 shadow-lg text-center group hover:shadow-2xl transition-all duration-300">
            ...
            <p class="text-accent font-semibold mb-4">{{ member.position }}</p>
            <p class="text-muted text-sm">{{ member.bio }}</p>
            <a 
              *ngIf="member.linkedin" 
              [href]="member.linkedin" 
              target="_blank"
              class="inline-flex items-center mt-4 text-accent hover:text-accent/80 font-medium"
            >
    ...
    <section class="py-16 bg-accent">
      <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-black mb-4">Ready to Join the WishCowork Family?</h2>
        <p class="text-black/80 mb-8 text-lg">
          Discover how our workspace solutions can transform your business. Schedule a tour today.
        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <button routerLink="/contact" class="bg-black text-white hover:bg-black/80 font-bold py-3 px-8 rounded-xl transition-all duration-300">
            Get in Touch
          </button>
          <button routerLink="/plans" class="border-2 border-black text-black hover:bg-black hover:text-white font-bold py-3 px-8 rounded-xl transition-all duration-300">
            View Our Plans
          </button>
        </div>
      </div>
...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.updateMetaTags({
      title: `About Us - Our Mission & Vision | ${appName}`,
      description: `At WishCowork, we're building more than workspaces – we're creating communities where entrepreneurs, freelancers, and businesses thrive together.`,
      keywords: 'about wishcowork, coworking mission, workspace vision, office community'
    });
  }
